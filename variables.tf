...
variable "create_ecs_cluster" {
  description = "Indicates if creates a new ECS cluster"
  type        = bool
  default     = false
}
...
variable "health_check_path" {
  description = "The path the ALB periodically sends requests to its registered targets to test their status."
  type        = string
  default     = "/"
}
